...
import { Calendar, MapPin, Clock, Users, Camera, Heart, Star, Sparkles, MessageCircle, Award, Ribbon } from 'lucide-react'
...
export default function EventsPage() {
  ...
  const openWhatsApp = (type: string) => {
    ...
    switch(type) {
      case 'newsletter':
        message = "Hello! I would like to subscribe to BRD Public School's newsletter to stay updated about upcoming events, activities, and important announcements."
        break
      case 'calendar':
        message = "Hello! I would like to get the complete event calendar for BRD Public School. Please share the schedule of upcoming events and activities."
        break
    }
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <h1 className="text-5xl md:text-6xl font-bold text-gray-800 mb-6">
              Celebrating Learning & Culture
            </h1>
            <p className="text-xl text-gray-600 leading-relaxed">
              At BRD Public School, we believe in celebrating every moment of learning through 
              vibrant festivals, cultural events, and educational activities that enrich our students' lives.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              A historic moment as BRD Public School officially opened its doors to the community. 
              The grand inauguration ceremony was attended by distinguished guests, local officials, and community members.
            </p>
          </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our recent Sawan festival celebration was a beautiful blend of tradition, spirituality, and joy. 
              Students participated with great enthusiasm, showcasing Indian culture and values.
            </p>
          </div>
      ...
      <section className="py-16 bg-gradient-to-r from-blue-600 to-purple-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 max-w-3xl mx-auto">
            Don't miss out on any of our exciting school events and celebrations. 
            Subscribe to our newsletter or follow our social media for the latest updates.
          </p>
