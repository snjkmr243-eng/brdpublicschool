...
import { Building, Users, GraduationCap, MapPin, Phone, Mail, MessageCircle, Calendar, FileText, Briefcase } from 'lucide-react'
...
export default function CampusPage() {
  ...
  const openWhatsApp = (type: string) => {
    ...
    switch(type) {
      case 'admission':
        message = "Hello! I'm interested in admission to BRD Public School. Please provide me with detailed information about the admission process, fees, and available seats."
        break
      case 'job':
        message = "Hello! I'm interested in teaching opportunities at BRD Public School. I would like to submit my resume and learn about current job openings."
        break
      case 'visit':
        message = "Hello! I would like to schedule a campus visit to BRD Public School. Please let me know the available dates and times for a guided tour."
        break
    }
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-gray-600 leading-relaxed mb-8">
              Explore our state-of-the-art facilities designed to provide the best learning environment 
              for our students at BRD Public School, Kandawa.
            </p>
                  ...
                  <table className="w-full border-collapse border border-gray-300">
                    ...
                    <tbody>
                      ...
                      <tr className="bg-gray-50">
                        ...
                        <td className="border border-gray-300 px-4 py-3 font-medium">Kandawa, Ghamahapur (Near Film City), Varanasi-221106</td>
                      </tr>
                      <tr>
                  ...
                  <table className="w-full border-collapse border border-gray-300">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td className="border border-gray-300 px-4 py-3 font-medium">Mr. AJIT KUMAR VERMA M.A, B.Ed | Experience: 12+ years</td>
                      </tr>
                      <tr className="bg-gray-50">
                        ...
                        <td className="border border-gray-300 px-4 py-3">
                          <div className="space-y-1">
                            <div><strong>PGT:</strong> 13</div>
                            <div><strong>TGT:</strong> 8</div>
                            <div><strong>PRT:</strong> 7</div>
                          </div>
                        </td>
                      </tr>
                      <tr>
                ...
                <div className="overflow-x-auto">
                  <table className="w-full border-collapse border border-gray-300">
                    ...
                    <tbody>
                      <tr>
                        <td className="border border-gray-300 px-4 py-3">1</td>
                        <td className="border border-gray-300 px-4 py-3">TOTAL CAMPUS AREA OF THE SCHOOL (IN SQUARE MTS.)</td>
                        <td className="border border-gray-300 px-4 py-3 font-medium">11537</td>
                      </tr>
                      <tr className="bg-gray-50">
                        <td className="border border-gray-300 px-4 py-3">2</td>
                        <td className="border border-gray-300 px-4 py-3">NUMBERS AND SIZE OF CLASSROOMS (IN SQUARE MTS.)</td>
                        <td className="border border-gray-300 px-4 py-3 font-medium">21 ROOMS 525 Sq mts</td>
                      </tr>
                      <tr>
                        <td className="border border-gray-300 px-4 py-3">3</td>
                        <td className="border border-gray-300 px-4 py-3">NUMBER OF LARGE LABS INCLUDING COMPUTER LABS(IN SQUARE MTS.)</td>
                        <td className="border border-gray-300 px-4 py-3">
                          <div className="space-y-1">
                            <div><strong>Labs:</strong> 2.88 X 2.41 Sq mtr</div>
                            <div><strong>Computer Lab:</strong> 3.99 x 2.13 sq mts</div>
                          </div>
                        </td>
                      </tr>
                      <tr className="bg-gray-50">
      ...
      <section className="py-16 bg-gradient-to-r from-green-600 to-blue-600 text-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="bg-white/10 backdrop-blur-sm border-white/20 text-white text-center hover:bg-white/20 transition-colors cursor-pointer" onClick={() => openWhatsApp('admission')}>
              <CardHeader>
            ...
            <Card className="bg-white/10 backdrop-blur-sm border-white/20 text-white text-center hover:bg-white/20 transition-colors cursor-pointer" onClick={() => openWhatsApp('job')}>
              <CardHeader>
            ...
            <Card className="bg-white/10 backdrop-blur-sm border-white/20 text-white text-center hover:bg-white/20 transition-colors cursor-pointer" onClick={() => openWhatsApp('visit')}>
              <CardHeader>
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-lg mb-4">
                    <strong>BRD Public School</strong><br />
                    Kandawa, Ghamahapur<br />
                    (Near Film City)<br />
                    Varanasi - 221106<br />
                    Uttar Pradesh, India
                  </p>
